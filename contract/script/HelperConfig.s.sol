    ...
    constructor() {
        if (
            block.chainid == 1 // Ethereum - mainnet
                ...
                || block.chainid == 80_002 // Mumbai - testnet
                || block.chainid == 1287 // Moonbase - testnet
                || block.chainid == 88882 //Chiliz Spice Testnet
                || block.chainid == 59_140 //linea - testnet
                || block.chainid == 59141 //Linea Sepolia
                || block.chainid == 25_022_022 // Lumx (Tansi) -  mainnet
                || block.chainid == 1337 // Hyperledger Besu - mainnet
